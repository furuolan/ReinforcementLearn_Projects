...
def transition(s, a):
    ...
    if (alpha + a[0]) == beta + a[1]:
        ...
        # handle the case where the second player is sticking ( a attempts to move into b's original position)
        ...
        # bp_prime = 1 - ball_pos if not ball_pos == second_player else ball_pos
